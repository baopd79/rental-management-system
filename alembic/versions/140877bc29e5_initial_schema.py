...
def downgrade() -> None:
    """Downgrade schema."""
    # Drop circular FK trước (đối ứng với create ở upgrade)
    op.execute(
        "ALTER TABLE tenants "
        "DROP CONSTRAINT IF EXISTS fk_tenants_promoted_from_occupant_id_occupants"
    )
    # ... existing drop_table + DROP TYPE ...
    # ### commands auto generated by Alembic - please adjust! ###
